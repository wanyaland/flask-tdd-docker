...
def test_add_user(test_app, test_database):
    ...
    resp = client.post(
        "/users",
        data=json.dumps({"username": "wanyaland", "email": "wanyaland@gmail.com"}),
...
def test_add_user_invalid_json_keys(test_app, test_database):
    ...
    resp = client.post(
        "/users",
        data=json.dumps({"email": "harry@gmail.com"}),
        content_type="application/json",
    )
...
def test_add_user_duplicate_email(test_app, test_database):
    ...
    client.post(
        "/users",
        data=json.dumps({"username": "wanyaland", "email": "wanayaland@gmail.com"}),
        content_type="application/json",
    )
